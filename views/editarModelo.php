    ...
    <h4 class="text-center">Edita tus datos de Modelo</h4>
        ...
        <div class="row">
            ...
            <span class="input-group-text">N° Celular</span>
                ...
                aria-label="Username" aria-describedby="basic-addon1" id="celular" name="celular"
                value="<?= $_SESSION['modelo']['celular'] ?>">
            </div>
            <div class="col">
                <span class="input-group-text">Dirección</span>
                <input type="text" class="form-control" placeholder="Dirección" 
                aria-label="Username" aria-describedby="basic-addon1" id="direccion" name="direccion"
                value="<?= $_SESSION['modelo']['direccion'] ?>">
            </div>
        </div>
<br>
        <div class="row">
            ...
            <span class="input-group-text">Altura</span>
                <input type="text" class="form-control" placeholder="Altura en cm (168)" 
                aria-label="Username" aria-describedby="basic-addon1" id="altura" name="altura"
                value="<?= $_SESSION['modelo']['altura'] ?>">
            </div>
            <div class="col">
            <span class="input-group-text">Peso</span>
                <input type="text" class="form-control" placeholder="Peso Kg (87)" 
                aria-label="Username" aria-describedby="basic-addon1" id="peso" name="peso"
                value="<?= $_SESSION['modelo']['altura'] ?>">
            </div>
        </div>
