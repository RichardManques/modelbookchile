    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="./index.php" class="navbar-brand p-0">
                    <h1 class="m-0">Modelbook Agencia</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="./seccionSeleccionados.php" class="nav-item nav-link active">Lista favoritos</a>
                        <a href="../buscador.php" class="nav-item nav-link">Buscar</a>
                    </div>
                    <a href="../salir.php" class="btn btn-light rounded-pill text-primary py-2 px-4 ms-lg-5">Cerrar sesión</a>
                </div>
            </nav>
        </div>
        <!-- Navbar & Hero End -->
        ...
        <div class="container-xxl py-6">
            <div class="container">
                ...
                <form action="../../controllers/ControlPerfilModeloAgencia.php" method="POST">
                    <div class="row g-4">
