    ...
    public function ingresarModelo(){
        ...
        if (isset($_SESSION['usuario'])) {
            ...
            if(is_uploaded_file($temp1)) {
                ...
                $foto1 = 'http://localhost:80/modelbookchile/uploads/' . $nombre_foto1;
            }else {
                $foto1 = '';
            }
            ...
            if(is_uploaded_file($temp2)) {
                ...
                $foto2 = 'http://localhost:80/modelbookchile/uploads/' . $nombre_foto2;
            ...
            if(is_uploaded_file($temp3)) {
                ...
                $foto3 = 'http://localhost:80/modelbookchile/uploads/' . $nombre_foto3;
            ...
            if(is_uploaded_file($temp4)) {
                ...
                $foto4 = 'http://localhost:80/modelbookchile/uploads/' . $nombre_foto4;
